...
public:
    ScriptedEntity(const std::string &name, const std::vector<std::shared_ptr<Shader>> &shaders, int health, const btVector3 &pos, float bsRadius, const btQuaternion &rot, const std::string &model, float mass,
