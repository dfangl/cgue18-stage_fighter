...
lights = {
    ...
    PointLight(vec3(-15,1.5,27.0495), vec3(0.0,0.0,0.0), vec3(0.4,0.4,0.4), vec3(0.1,0.1,0.1), 15),

    PointLight(vec3(10,1.5,5), vec3(0.0,0.0,0.0), vec3(0.4,0.4,0.4), vec3(0.1,0.1,0.1), 15),
