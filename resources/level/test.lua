...
entities = {
    dynamics.turret("Turret #1", 1, 1000,  vec3(-24.7897,-42.5088,1.65117), vec4(0,0,0,1)),
    dynamics.turret("Turret #2", 1, 1000,  vec3(-50.2492,-42.5088,-25.1359), vec4(0,0.707107,0,0.707107)),
