particles.smoke = ParticleSystem(1.0, "particlesystem", "smoke.png", {
    ...
    generateParticles = function(this, count)
        for i=0, count do
            ...
            local speed = noise.stb_perlin_ridge_noise3(18 * nx, 18 * ny, 5 * this.nz1, 2.0, 0.5, 1.0, 24, 18, 18, 64) * 400
            local ttl   = math.random(2000, 3499)
            ...
            local x = math.cos(math.random(2000, 3499)) * 1.4
            local y = math.sin(math.random(2000, 3499)) * 1.4
            local z = math.tan(math.random(2000, 3499)) * 1.4

            this.push_particle(
                vec3(x, y, z),
                vec3(noiseX, noiseY, noiseZ),
                ttl - math.random(2000, 3499),
                ttl
            )
        end
    end
