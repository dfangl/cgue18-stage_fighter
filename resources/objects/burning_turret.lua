particles.burning_turret = ParticleSystem(1.0, {"particlesystem"}, "explosion.png", {

    init = function(this)
        this.setSize(3.0, 3.0)
        this.nz1 = 15.2938648971363;
        this.nz2 = 12.1293682342339;
        this.nz3 = 20.3745902239486;
    end,
    ...
    generateParticles = function(this, count)
        for i=0, count do
            ...
            local speed = noise.stb_perlin_ridge_noise3(18 * nx, 18 * ny, 5 * this.nz1, 2.0, 0.5, 1.0, 24, 18, 18, 64) * 500
            ...
            local x = math.cos(math.random(0, 360)) * 0.4
            local y = math.sin(math.random(0, 360)) * 0.4
            local z = math.sin(math.random(0, 360)) * 0.4
